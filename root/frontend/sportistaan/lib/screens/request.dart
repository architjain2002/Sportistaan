      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Column(
            ...
            Text('Preffered gender', style: kLabelTextStyle,),
            DropdownButton(
              value:gender,
              style: const TextStyle(color: Color(0xFFFFC833),),
              items: <String>['Anyone', 'Male', 'Female'].map<DropdownMenuItem<String>>((String value) {
